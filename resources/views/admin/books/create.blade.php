                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('admin.books.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="title" name="title" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" value="{{ old('title') }}" required>
                        </div>

                        <!-- Поле для автора -->
                        <div class="mb-4">
                            <label for="author" class="block text-sm font-medium text-gray-700">Author</label>  <!-- Автор -->
                            <input type="text" id="author" name="author" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" value="{{ old('author') }}" required>
                        </div>
