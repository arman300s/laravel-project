        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <a href="<?php echo e(route('admin.users.create')); ?>" class="btn btn-primary font-semibold mb-4 ">Add New User</a>
                        ...
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 transition-all duration-300">
                                ...
                                <td class="px-4 py-2 border">
                                    <a href="<?php echo e(route('admin.users.edit', $user->id)); ?>" class="text-blue-500">Edit</a>
...
<?php endif; ?>
<?php /**PATH /Users/bekzatsaparbekov/LaravelProject/LaravelProject1/resources/views/admin/users/index.blade.php ENDPATH**/ ?>