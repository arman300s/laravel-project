...
<?php endif; ?>
<?php $component->withAttributes(['header' => 'Edit Reservation']); ?>
                    ...
                    <div>
                        ...
                        <select id="user_id" name="user_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($user->id); ?>" <?php echo e($reservation->user_id == $user->id ? 'selected' : ''); ?>><?php echo e($user->name); ?></option>
                    ...
                    <div>
                        ...
                        <select id="book_id" name="book_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                            <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($book->id); ?>" <?php echo e($reservation->book_id == $book->id ? 'selected' : ''); ?>><?php echo e($book->title); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="date" id="expiration_date" name="expiration_date"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                               value="<?php echo e(old('expiration_date', $reservation->expiration_date->format('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select id="status" name="status" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                            ...
                            <option value="approved" <?php echo e($reservation->status == 'approved' ? 'selected' : ''); ?>>Approved</option>
                            <option value="rejected" <?php echo e($reservation->status == 'rejected' ? 'selected' : ''); ?>>Rejected</option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-6">
                    ...
                    <textarea id="notes" name="notes" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"><?php echo e(old('notes', $reservation->notes)); ?></textarea>
...
<?php endif; ?>
<?php /**PATH /var/www/laravel-project/resources/views/admin/reservations/edit.blade.php ENDPATH**/ ?>